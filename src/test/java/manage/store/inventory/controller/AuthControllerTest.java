...
class AuthControllerTest {
    ...
    void login_success_returns200() throws Exception {
        AuthResponseDTO response = new AuthResponseDTO("jwt_token", null, 1L, "testuser", "Test User", List.of("USER"), null);
    ...
    void register_success_returns200() throws Exception {
        AuthResponseDTO response = new AuthResponseDTO("jwt_token", null, 2L, "newuser", "New User", List.of("USER"), null);
