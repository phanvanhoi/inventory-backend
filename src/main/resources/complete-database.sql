...
-- product_id = 12
INSERT INTO products (product_name, variant_type, parent_product_id, note, created_at) VALUES
('GILE LEN VNPT', 'STRUCTURED', 5, 'Áo len + Gile len 2026 - VNPT', NOW());
-- product_id = 13
INSERT INTO products (product_name, variant_type, parent_product_id, note, created_at) VALUES
...
-- Child của SP2 (SƠ MI NAM 2026) — cùng ma trận variant với SP1
INSERT INTO products (product_name, variant_type, parent_product_id, note, created_at) VALUES
...
-- ====== Product 13: GILE LEN VNPT (child của SP5) ======
INSERT INTO product_variants (product_id, size_id, gender) VALUES
...
-- =====================================================
-- PHẦN 4: DỮ LIỆU KHO VẢI (Product 8)
-- 4a: Tồn ban đầu CÔNG TY (274 mã từ CSV)
-- 4b–4k: Tồn ban đầu trực tiếp từng kho thợ
-- =====================================================

-- =====================================================
-- PHẦN 4a: TỒN KHO BAN ĐẦU VẢI — CÔNG TY (Product 8)
